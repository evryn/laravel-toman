...
| متد      	| توضیحات  	|
|-------------	|---------------------------------------------------------------------------------------------------------------------------------	|
| &lrm;amount(`$amount`)      	| **(الزامی)** تنظیم مبلغ قابل پرداخت. این درگاه واحد پولیش ریاله.  	|
| &lrm;orderId(`$orderId`)      	| **(الزامی)** تنظیم شناسه سفارش. این شناسه یه رشته هست که سمت شما به صورت یکتا باید ساخته بشه و موقع تایید پرداخت ازش استفاده بشه.  	|
...
| &lrm;name(`$name`)       	| تنظیم نام پرداخت‌کننده. |
